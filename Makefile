...
SOURCES=src/arg_parser.cpp src/canvas.cpp src/color.cpp src/file_helper.cpp src/image.cpp src/img_iter.cpp src/main.cpp src/poly_mutator.cpp src/polygon.cpp src/viewer.cpp
